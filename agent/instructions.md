...
After a run, reply with one or two plain sentences stating what was decided. On GitHub runs this reply is only logged. On Discord it is what the maintainer reads next to the approval prompt.
